...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2026-01-18 | 5.0.3 | Redis缓存测试通过: 完整记忆系统验证(缓存连接、冲突检测、降权旧记忆、跨员工共享4条) |
| 2026-01-18 | 5.0.2 | AI员工记忆系统测试验证通过: 18员工加载、AI对话、4维评分过滤(≥2.0)、两阶段检索、跨员工共享 |
| 2026-01-18 | 5.0.1 | Python 3.9兼容性修复: base.py类型注解从`Type | None`改为`Optional[Type]` |
