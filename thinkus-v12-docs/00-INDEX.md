...
| 文档 | 描述 |
|------|------|
| 17-MULTI-AGENT-COLLABORATION.md | 🆕 多智能体协作架构 (参考Cursor FastRender) |
...
```
Phase 1 (1月): 基础升级
  - 多智能体分层架构 (Planner-Worker-Judge) [参考Cursor]
  - 计划先行 + 版本追踪
  - 防摸鱼机制 [参考Cursor]
...
┌────────────────────────────────────────────────────────────┐
│                                                            │
│  Planner层: Mike(PM) + 专家子规划                         │
│      ↓ 任务分配 (带难度标记，防摸鱼)                      │
│  Worker层: Subagents (并行执行)                           │
│      ↓ 产出提交                                            │
│  Judge层: Kevin(QA) + Auto-Verify                         │
│      ↓ 评估: 通过/返工/重启 (检查点机制)                  │
│                                                            │
└────────────────────────────────────────────────────────────┘

参考: Cursor FastRender (300万行代码，数百智能体协作)
```
